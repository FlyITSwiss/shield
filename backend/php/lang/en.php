...
return [
    ...
    'settings.alarm_sound_desc' => 'Choose the sound that will play during an alert',
    'settings.sound_siren' => 'Siren',
    'settings.sound_horn' => 'Horn',
    'settings.sound_alarm' => 'Classic alarm',
    'settings.sound_whistle' => 'Whistle',
    'settings.sound_voice' => 'Voice (Help!)',
    'settings.preview_sound' => 'Listen',
